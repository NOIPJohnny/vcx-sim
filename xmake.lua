...
target("lab4")
    ...
    add_packages("eigen")
    add_packages("fcl")
    add_headerfiles("src/VCX/Labs/4-Coupling/*.h")
    add_headerfiles("src/VCX/Labs/4-Coupling/*.hpp")
    add_files      ("src/VCX/Labs/4-Coupling/*.cpp")
    add_headerfiles("src/VCX/Labs/3-FEM/FEMSystem.h")
    add_headerfiles("src/VCX/Labs/3-FEM/FEMSoftBodyBuilder.h")
    add_headerfiles("src/VCX/Labs/3-FEM/Integrator.h")
    add_headerfiles("src/VCX/Labs/3-FEM/FEMElement.h")
    add_headerfiles("src/VCX/Labs/3-FEM/HyperElasticModels.h")
    add_files      ("src/VCX/Labs/3-FEM/FEMSystem.cpp")
    add_files      ("src/VCX/Labs/3-FEM/FEMSoftBodyBuilder.cpp")
    add_files      ("src/VCX/Labs/3-FEM/Integrator.cpp")
    if is_plat("windows") then
        add_cxflags("/EHsc")
    end
